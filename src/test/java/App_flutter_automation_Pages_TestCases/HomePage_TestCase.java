...
import laegeforeningen_flutter_automation_Pages_Implementation.HomePage_Implementation;
...
public class HomePage_TestCase extends BaseConfiguration{
	
	 HomePage_Implementation home= new HomePage_Implementation();
